...
MainWindow::MainWindow(QWidget *parent) : QMainWindow( parent ),_ui( new Ui::MainWindow ){
    ...
    // Class TreeView implementation - Corum
    _classTreeWidget=new QTreeView;

    _classDockWidget=new QDockWidget;
    _classDockWidget->setObjectName( "classDockWidget" );
    _classDockWidget->setAllowedAreas( Qt::LeftDockWidgetArea | Qt::RightDockWidgetArea );
    _classDockWidget->setFeatures(QDockWidget::DockWidgetMovable | QDockWidget::DockWidgetFloatable );
    _classDockWidget->setWindowTitle( "Class View" );
    _classDockWidget->setWidget( _classTreeWidget );

    addDockWidget( Qt::LeftDockWidgetArea,_classDockWidget );
